...
class Cat5 extends StatefulWidget {
  ...
  _Cat5State createState() => _Cat5State();
}

class _Cat5State extends State<Cat5> with SingleTickerProviderStateMixin {
  bool isEnglishToTurkish = true;

  final List<Map<String, String>> words = [
    {'word': 'Airplane', 'meaning': 'Uçak'},
    {'word': 'Ambulance', 'meaning': 'Ambulans'},
    {'word': 'Bicycle', 'meaning': 'Bisiklet'},
    {'word': 'Boat', 'meaning': 'Tekne'},
    {'word': 'Bus', 'meaning': 'Otobüs'},
    {'word': 'Car', 'meaning': 'Araba'},
    {'word': 'Fire truck', 'meaning': 'İtfaiye aracı'},
    {'word': 'Helicopter', 'meaning': 'Helikopter'},
    {'word': 'Hot air balloon', 'meaning': 'Sıcak hava balonu'},
    {'word': 'Motorcycle', 'meaning': 'Motosiklet'},
    {'word': 'Scooter', 'meaning': 'Scooter'},
    {'word': 'Skateboard', 'meaning': 'Kaykay'},
    {'word': 'Subway', 'meaning': 'Metro'},
    {'word': 'Taxi', 'meaning': 'Taksi'},
    {'word': 'Tractor', 'meaning': 'Traktör'},
    {'word': 'Train', 'meaning': 'Tren'},
    {'word': 'Truck', 'meaning': 'Kamyon'},
    {'word': 'Van', 'meaning': 'Minibüs'},
    {'word': 'Wagon', 'meaning': 'Vagon'},
    {'word': 'Yacht', 'meaning': 'Yat'},
  ];
